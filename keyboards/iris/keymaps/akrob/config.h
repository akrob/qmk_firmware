...
#define NO_USB_STARTUP_CHECK //keep both sides on when pc is sleeping. (Helps with the lighting during sleep)
...
// Features to tune the tapping behavior (specially useful for MOD tap and Layer Tap dual keys)
